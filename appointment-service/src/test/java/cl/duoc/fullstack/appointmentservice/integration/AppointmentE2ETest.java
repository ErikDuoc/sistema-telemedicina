...
class AppointmentE2ETest {
    ...
    @Test
    @DisplayName("Crear cita con paciente valido debe retornar 201")
    void crearCita_conPacienteValido_retorna201() throws Exception {
        String requestBody = "{\"patientId\": 1, \"doctorId\": 1, \"appointmentDate\": \"2026-07-20T10:00:00\", \"type\": \"CONSULTATION\"}";
